...
export default function CausesHome() {
  return (
    <div className="md:w-[1400px] w-fit mx-auto bg-gray-300 mt-4 p-8 h-fit">
      <h1 className="text-center p-1 text-orange-500 font-extralight border-2 bg-white rounded-2xl w-fit mx-auto">
        Feature Causes
      </h1>
      <h2 className="text-center font-bold text-4xl my-4">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-2 md:gap-8 ">
        <Card className="w-[300px] py-0 border-y-4 border-orange-600 px-8 mx-auto">
          ...
          <CardDescription className="text-center">
            Donasi ini dikhususkan untuk memberikan akses pendidikan bagi
          ...
          <img src={imagecourse} alt="pendidikan" className="mb-4" />
        </Card>
        <Card className="w-[300px] py-0 border-y-4 border-orange-600 px-8  mx-auto ">
          <CardTitle className="mx-auto text-white py-2 px-4 rounded-sm bg-orange-500 w-fit">
            Air Bersih
