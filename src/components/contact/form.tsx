...
export default function FormContact() {
  return (
    <div className="mt-20 grid grid-cols-1 lg:grid-cols-2 gap-4 p-4 md:p-0 h-screen">
      <div className="">
        <div className=" ms-4 my-4 ">
          ...
          <p className="text-4xl font-bold my-4">If You Have Any Query,<br /> Please Contact Us</p>
        </div>
        <Card className="p-4 mx-4">
          ...
          <Button className="bg-orange-500 hover:bg-orange-400 w-1/2 mx-auto">Send Messages</Button>
        </Card>
      </div>
      <div className="">
        <iframe
